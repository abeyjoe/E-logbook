...
<?php
    if (isset($_POST['addstudent'])) {
        ...
        $query = "INSERT INTO users (username, password, branch, role) VALUES ('$username', '$password', '$branch', '$role')";
        $result = mysqli_query($connection, $query);
        if ($result) {
            echo "<script>
            alert('User Added!');
            window.location.href = 'availableusers.php';
            </script>";
        }else{
            echo "<script>alert('Error!');</script>";
                 header("Refresh:0; url=availableusers.php");
        }
    }
?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="availableusers.php" method="POST">
            <label style="color: black;">Username</label>
            <input type="text" name="username" class="form-control" placeholder="Enter Username">
            <label style="color: black;">Password</label>
            <input type="text" name="password" class="form-control" placeholder="Enter Password">
            <label style="color: black;">Siwes Center/Student Name</label>
            <input type="text" name="branch" class="form-control" placeholder="Place of IT">
            <input type="hidden" name="role" value="user" class="form-control" placeholder="username">
...
<div class="container" style="margin-top: 70px;">
    ...
    $nquery=mysqli_query($connection,"select * from `users` WHERE role='$role' $limit");
